...
| Cenário | Resultado |
| --- | ---: |
| catálogo completo, 20 tools | 13.976 B; ~3.494 tokens |
| catálogo somente leitura, 16 tools | 9.597 B; ~2.400 tokens |
| redução do catálogo somente leitura | 31,33% |
| build + encode do catálogo | 0,0219 ms mediano |
...
| parse + decode do histórico inicial | 293,331× mais rápido |
| heap inicial do histórico | 99,576% menor |
| busca em output de 64 MiB, 65.536 B → 110 B | 99,8322% menor; 56,77 ms |
...
| Cenário | Resultado |
| --- | ---: |
| streaming de texto batched | 194,670× o caminho sequencial |
| streaming de comando framed | 71,516× o caminho sequencial |
| diff de 150.001 linhas | 45 linhas montadas; janela em 0,325 ms |
| terminal incremental de 64 MiB | 1.499,04 ms; 42,7 MiB/s |
| comando após yield | resposta em 260 ms; trabalho independente em 487 ms |
| polling incremental | 146 B contra snapshot de 16.513 B |
| 4 comandos independentes | 739,22 ms paralelo contra 2.918,75 ms sequencial |
